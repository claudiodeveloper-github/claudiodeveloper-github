...
[![Minhas Tecnologias](https://skillicons.dev/icons?i=java,spring,springsecurity,hibernate,maven,postgres,mysql,docker,git,github,linux,postman,idea,html,css,js,bootstrap)](https://skillicons.dev)
